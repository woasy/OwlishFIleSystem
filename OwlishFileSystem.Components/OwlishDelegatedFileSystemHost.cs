...
{
    public class OwlishDelegatedFileSystemHost : IOwlishFileSystemHost
    {
        ...
        public Task<bool> GetIsFileExistAsync(IOwlishFile file, IObserver<OwlishProgress> progressObserver, System.Threading.CancellationToken ct)
        {
            return GetIsFileExistAsyncDelegaters.InvokeIfHasTarget(file, progressObserver, ct);
        }

        public Task<bool> GetIsDirectoryExistAsync(IOwlishDirectory directory, IObserver<OwlishProgress> progressObserver, System.Threading.CancellationToken ct)
        {
            return GetIsDirectoryExistAsyncDelegaters.InvokeIfHasTarget(directory, progressObserver, ct);
        }

        public Task<PathExistResult> GetIsPathExistAsync(IOwlishPath path, IObserver<OwlishProgress> progressObserver, System.Threading.CancellationToken ct)
        {
        ...
        public Task<IOwlishDirectory> CreateDirectryAsync(IOwlishPath path, IObserver<OwlishProgress> progressObserver, System.Threading.CancellationToken ct)
        {
